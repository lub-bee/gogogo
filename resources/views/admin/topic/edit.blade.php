            ...
            <form method="POST" action="{{route('topic.update', $topic->id)}}">
                ...
                <div class="info">
                    ...
                    <div class="col-span-3">
                        ...
                        <input type="text" name="slug" class="form-input" value="{{old('slug',$topic->slug)}}">
                    </div>
                </div>
                ...
                <div class="info">
                    ...
                    <div class="col-span-3">
                        <div>
                            <label>
                                <input type="radio" name="status" value="draft" {{ old("status", $topic->published_at) == null ? 'checked' : '' }}>
                ...
                <div class="info">
                    {{-- created_at --}}
                    <div>Created at</div>
                    <div>{{ $topic->created_at->format('Y-m-d H:i:s') }}</div>

                    {{-- updated_at --}}
                    <div>Updated at</div>
                    <div>{{ $topic->updated_at->format('Y-m-d H:i:s') }}</div>
                </div>
